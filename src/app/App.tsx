                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden md:flex space-x-8">
                            <button onClick={() => scrollToSection("hero")} className="text-gray-300 hover:text-orange-400 transition-colors">
                                Início
                            </button>
                            <button onClick={() => scrollToSection("servicos")} className="text-gray-300 hover:text-orange-400 transition-colors">
                                Serviços
                            </button>
                            <button onClick={() => scrollToSection("sobre")} className="text-gray-300 hover:text-orange-400 transition-colors">
                                Sobre
                            </button>
                            <button onClick={() => scrollToSection("contato")} className="text-gray-300 hover:text-orange-400 transition-colors">
                                Contato
                            </button>
                        </nav>
